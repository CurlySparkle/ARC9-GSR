text = { -- English
    ...
    ["glock_use"] = "• Deadly up close, just a nuisance at range[br]• Consider in the first round of the half[br]• Difficulty: ★★</font>",
    ["hkp2000_use"] = "• Accurate at range, spammable up close[br]• Consider in the first round of the half[br]• Difficulty: ★★</font>",
    ["usp_silencer_use"] = "• Precise, silent, and (somewhat) deadly[br]• Consider in the first round of the half[br]• Difficulty: ★★</font>",
    ["elite_use"] = "• Two rapid-fire pistols for the price of one[br]• Consider in the first round of the half[br]• Difficulty: ★★</font>",
    ["p250_use"] = "• A popular, if modest, damage upgrade[br]• Consider in eco rounds[br]• Difficulty: ★</font>",
    ["fiveseven_use"] = "• Power, speed, and precision for a price[br]• Consider in eco rounds[br]• Difficulty: ★★</font>",
    ["cz75a_use"] = "• A burst of firepower to steal enemy weapons[br]• Consider in eco rounds[br]• Difficulty: ★★★★</font>",
    ["tec9_use"] = "• Highly mobile, effective at range and up close[br]• Consider in eco rounds[br]• Difficulty: ★★★</font>",
    ["revolver_use"] = "• Deals massive damage after a short delay[br]• Consider in eco rounds[br]• Difficulty: ★★★★</font>",
    ["deagle_use"] = "• A lethal headshot at any range[br]• Consider in eco rounds[br]• Difficulty: ★★★★</font>",
    ["taser_use"] = "• A rechargeable one shot kill at short range[br]• Attempt at your own risk[br]• Difficulty: ★★★★</font>",
    ["bizon_use"] = "• A hail of bullets to mow down unarmored enemies[br]• Consider in the first three rounds of the half[br]• Difficulty: ★★</font>",
    ["mac10_use"] = "• A run and gun tool for breaching bombsites[br]• Consider in the first three rounds of the half[br]• Difficulty: ★</font>",
    ["mp9_use"] = "• A burst of damage to deny an enemy rush[br]• Consider in the first three rounds of the half[br]• Difficulty: ★</font>",
    ["mp7_use"] = "• Easy to control for reliable mid-range damage[br]• Consider in force buy rounds[br]• Difficulty: ★★</font>",
    ["mp5sd_use"] = "• Nimble and stealthy for mid-range damage[br]• Consider in force buy rounds[br]• Difficulty: ★★</font>",
    ["ump45_use"] = "• Good armor penetration for mid-range fights[br]• Consider in force buy rounds[br]• Difficulty: ★★★</font>",
    ["p90_use"] = "• An endless bullet hose bested only by rifles[br]• Consider in full buy rounds[br]• Difficulty: ★</font>",
    ["galilar_use"] = "• Cheap but effective against armored enemies[br]• Consider in force buy rounds[br]• Difficulty: ★★★</font>",
    ["famas_use"] = "• Cheap but effective against armored enemies[br]• Consider in force buy rounds[br]• Difficulty: ★★★</font>",
    ["ak47_use"] = "• The classic, accurate, and deadly workhorse[br]• Consider in full buy rounds[br]• Difficulty: ★★★★</font>",
    ["m4a1_use"] = "• Good accuracy, with ammo to spare[br]• Consider in full buy rounds[br]• Difficulty: ★★★</font>",
    ["m4a1_silencer_use"] = "• Precise, silent, tracer-free[br]• Consider in full buy rounds[br]• Difficulty: ★★★</font>",
    ["aug_use"] = "• An optional scope for exceptional accuracy[br]• Consider in full buy rounds[br]• Difficulty: ★★★</font>",
    ["sg556_use"] = "• A lethal weapon made deadlier with a scope[br]• Consider in full buy rounds[br]• Difficulty: ★★★</font>",
    ["awp_use"] = "• Devastating power for the confident sniper[br]• Consider in full buy rounds[br]• Difficulty: ★★★</font>",
    ["g3sg1_use"] = "• High risk/reward automatic sniper rifle[br]• Consider only under special circumstances[br]• Difficulty: ★★★</font>",
    ["scar20_use"] = "• A potent (if risky) tool to hold a position[br]• Consider only under special circumstances[br]• Difficulty: ★★★</font>",
    ["ssg08_use"] = "• Light and powerful long-distance damage dealer[br]• Consider in force buy rounds[br]• Difficulty: ★★★★</font>",
    ["mag7_use"] = "• Take the enemy by surprise, reload, repeat![br]• Consider in force buy rounds[br]• Difficulty: ★★</font>",
    ["nova_use"] = "• Versatile shotgun for close quarter combat[br]• Consider in force buy rounds[br]• Difficulty: ★★</font>",
    ["sawedoff_use"] = "• High powered shotgun for close engagements[br]• Consider in force buy rounds[br]• Difficulty: ★★</font>",
    ["xm1014_use"] = "• A full-auto rapid-fire monster[br]• Consider in force buy rounds[br]• Difficulty: ★</font>",
    ["m249_use"] = "• At least you won't have to reload...[br]• Consider only under special circumstances[br]• Difficulty: ★★★</font>",
    ["negev_use"] = "• Pin-point suppressive fire to buy some time[br]• Consider in force buy rounds[br]• Difficulty: ★★★★</font>",
    ["hegrenade_use"] = "• Deal damage or clear smoke grenades[br]• Use with discretion[br]• Difficulty: ★★★</font>",
    ["flashbang_use"] = "• Blinds/deafens nearby players[br]• Throw prior to an attack[br]• Difficulty: ★★★★</font>",
    ["smokegrenade_use"] = "• Creates a large smoke cloud[br]• Throw to cut off enemy line of sight[br]• Difficulty: ★★★</font>",
    ["decoy_use"] = "• Mimics a weapon firing sound[br]• Throw early to confuse the enemy[br]• Difficulty: ★★★</font>",
    ["molotov_use"] = "• Clears out hiding spots with fire[br]• Throw before attacking a bombsite[br]• Difficulty: ★★★</font>",
    ["incgrenade_use"] = "• Stifles enemy attacks with fire[br]• Throw at the first sign of trouble[br]• Difficulty: ★★★</font>",
    ["assaultsuit_use"] = "• Survive all but the most lethal bullets[br]• Consider in full buy and force buy rounds[br]• Difficulty: ★</font>",
    ["kevlar_use"] = "• Protects everything but your head[br]• Consider in the first round of the half[br]• Difficulty: ★</font>",
    ["defuser_use"] = "• Cut your defusing time in half[br]• Don't be a loser, buy a defuser![br]• Difficulty: ★</font>",
    ["cutters_use"] = "• Pick up hostages in a fraction of the time[br]• Consider when you have extra funds[br]• Difficulty: ★</font>",
