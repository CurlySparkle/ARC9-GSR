...
SWEP.PrintName = ARC9:GetPhrase("csgo_weapon_knife_bayonet")
...
SWEP.Description = ARC9:GetPhrase("csgo_description_knife_bayonet")

SWEP.ViewModel = "models/weapons/csgo/knifes/c_knife_bayonet.mdl"
