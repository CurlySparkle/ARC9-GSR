...
SWEP.Class = "Grenade"
SWEP.Description = [[When thrown, the incendiary grenade releases a high-temperature chemical reaction capable of burning anyone within its wide blast radius.]]
SWEP.Trivia = {
    ["Country"] = "USA",
    ["Year"] = "1968",
}
...
SWEP.ShootEnt = "arc9_gsr_thrownincen"
SWEP.Ammo = "grenade"
