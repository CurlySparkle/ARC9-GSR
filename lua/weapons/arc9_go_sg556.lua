...
SWEP.Trivia = {
    ...
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 4.1, 4.1 * 2.20),
...
SWEP.Description = "csgo_description_sg556"
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = { "go_perk", "go_perk_burst", "go_perk_sg553" },
        Bone = "v_weapon.sg556_Parent",
        Pos = Vector(0, 3.5, 9),
    },
    {
