...
SWEP.Trivia = {
    ...
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 0.56, 0.56 * 2.20),
...
SWEP.Description = "csgo_description_akimbo_glock"
...
SWEP.AttachmentElements = {
    ["csgo_dual_glock_mag_32"] = { Bodygroups = { { 0, 1 }, { 2, 1 } } },
    ["csgo_dual_glock_slide_long"] = { Bodygroups = { { 1, 1 } } },
}
