...
SWEP.Trivia = {
    ["csgo_trivia_country1"] = "csgo_trivia_country_czech_republic",
    ["csgo_trivia_caliber2"] = "csgo_caliber_919",
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 2.24, 2.24 * 2.20),
...
SWEP.Description = "csgo_description_akimbo_cz75"
