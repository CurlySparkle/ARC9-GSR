...
SWEP.Class = "csgo_class_weapon_special"

SWEP.Trivia = {
    ["csgo_trivia_country1"] = "csgo_trivia_country_usa",
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 1, 1 * 2.20),
}
...
SWEP.Description = "csgo_description_akimbo_taser"
...
SWEP.RecoilDissipationRate = 1.5 -- How much recoil dissipates per second.
