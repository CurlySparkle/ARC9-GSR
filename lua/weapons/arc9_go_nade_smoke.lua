SWEP.CustomSelectIcon = Material("vgui/hud/arc9_go_nade_smoke")
...
SWEP.PrintName = ARC9:GetPhrase("csgo_weapon_nade_smoke")
SWEP.Class = ARC9:GetPhrase("csgo_class_weapon_grenade")
SWEP.Description = ARC9:GetPhrase("csgo_description_nade_smoke")
SWEP.Trivia = {
...
SWEP.ViewModel = "models/weapons/csgo/v_eq_smoke.mdl"
SWEP.WorldModel = "models/weapons/csgo/w_eq_smoke_grenade.mdl"
...
SWEP.ShootEnt = "arc9_gsr_thrownsmoke"
SWEP.Ammo = "grenade"
