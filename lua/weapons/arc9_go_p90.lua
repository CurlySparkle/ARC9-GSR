...
SWEP.Trivia = {
    ...
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 2.6, 2.6 * 2.20),
...
SWEP.Description = "csgo_description_p90"
...
SWEP.RecoilDissipationRate = 4 -- How much recoil dissipates per second.
...
SWEP.CustomizePos = Vector(14, 37.5, 4.5)

SWEP.CustomizeRotateAnchor = Vector(14, -5, -4)
...
SWEP.Attachments = {
    ...
    {
        PrintName = "csgo_category_gripping",
        Category = {"grip_p90"},
        Bone = "v_weapon.p90_Parent",
        Pos = Vector(0, -1, 4.7),
        Ang = Angle(90, 0, 90),
