...
SWEP.Class = "csgo_class_weapon_shotguns"

SWEP.Trivia = {
    ["csgo_trivia_country1"] = "csgo_trivia_country_usa",
    ["csgo_trivia_caliber2"] = "csgo_caliber_12gauge",
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 0.9, 0.9 * 2.20),
...
SWEP.Description = "csgo_description_akimbo_sawnoff"
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        --Bone = "v_weapon.Clip",
        Category = "go_skins_sawnoff_dual",
