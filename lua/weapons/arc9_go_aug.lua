...
SWEP.Trivia = {
    ...
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 3.6, 3.6 * 2.20),
...
SWEP.Description = "csgo_description_aug"
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = { "go_perk", "go_perk_burst", "go_perk_aug" },
        Bone = "v_weapon.aug_Parent",
        Pos = Vector(0, 4, 3),
    },
    {
