...
SWEP.Class = "csgo_class_weapon_smgs"

SWEP.Trivia = {
    ["csgo_trivia_country1"] = "csgo_trivia_country_switzerland",
    ["csgo_trivia_caliber2"] = "csgo_caliber_919",
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 3.68, 3.68 * 2.20),
...
SWEP.Description = "csgo_description_akimbo_mp9"
...
SWEP.VisualRecoilPositionBumpUpSights = .75
...
SWEP.CustomizePos = Vector(12.5, 47.5, 4.5)

SWEP.CustomizeRotateAnchor = Vector(12.5, 0, -4)
