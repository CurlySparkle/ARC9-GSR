...
SWEP.Trivia = {
    ...
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 3.75, 3.75 * 2.20),
...
SWEP.Description = "csgo_description_galil"
