...
SWEP.Trivia = {
    ...
    [ARC9:GetPhrase("csgo_trivia_weight")] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 1.48, 1.48 * 2.20),
...
SWEP.Description = ARC9:GetPhrase("csgo_description_akimbo_fiveseven")
...
SWEP.CustomizePos = Vector(18, 32.5, 2.5)
