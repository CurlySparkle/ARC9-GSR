...
SWEP.PrintName = ARC9:GetPhrase("csgo_weapon_akimbo_fiveseven")

SWEP.Class = "csgo_class_weapon_pistols"

SWEP.Trivia = {
    ["csgo_trivia_country1"] = "csgo_trivia_country_belgium",
    ["csgo_trivia_caliber2"] = "csgo_caliber_57",
    ["csgo_trivia_weight3"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_val"), 1.48, 1.48 * 2.20),
    ["csgo_trivia_weight_projectile4"] = string.format( ARC9:GetPhrase("csgo_trivia_weight_projectile_val"), 27 ),
}
...
SWEP.Description = "csgo_description_akimbo_fiveseven"
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        StickerModel = "models/weapons/stickers/v_models/akimbo_fiveseven_a.mdl",
        Category = "stickers",
        Bone = "tag_pistol_attachments_l",
        Pos = Vector(5, 0, 2),
    },
    {
        PrintName = "csgo_category_sticker",
        StickerModel = "models/weapons/stickers/v_models/akimbo_fiveseven_b.mdl",
        Category = "stickers",
        Bone = "tag_pistol_attachments_l",
        Pos = Vector(3, 0, 2),
    },
    {
        PrintName = "csgo_category_sticker",
        StickerModel = "models/weapons/stickers/v_models/akimbo_fiveseven_c.mdl",
        Category = "stickers",
        Bone = "tag_pistol_attachments_l",
        Pos = Vector(1, 0, 2),
    },
    {
        PrintName = "csgo_category_sticker",
        StickerModel = "models/weapons/stickers/v_models/akimbo_fiveseven_d.mdl",
        Category = "stickers",
        Bone = "tag_pistol_attachments_l",
        Pos = Vector(-1, 0, 2),
    },
