...
ATT.Description = [[
9mm conversion, turning the LMG into a submachine gun with a massive capacity, similar to the SMG 08/18.
]]
ATT.Pros = {}
ATT.Cons = {}
ATT.SortOrder = 5
...
ATT.Description = [[
Conversion for the M249, turning it into a 12 gauge automatic shotgun. (Crazy right?)
]]
ATT.Pros = {}
ATT.Cons = {}
ATT.SortOrder = 5
