...
ATT.Description = [[An explosive auxiliary device right in the comfort of your handguard or floating rails.]]
ATT.Pros = {}
ATT.Cons = {}
ATT.SortOrder = 100
ATT.Folder = "UBGL"
...
//ATT.Icon = Material("entities/attachs/go_attach_ubgl_m230.png")
ATT.Description = [[An aiming module for extra precision.]]
ATT.Pros = {}
ATT.Cons = {}
ATT.SortOrder = 1
