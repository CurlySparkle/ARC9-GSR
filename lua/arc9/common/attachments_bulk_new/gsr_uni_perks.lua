...
ATT.Icon = Material("entities/attachs/go_perk_fastreload.png")
...
ATT.Icon = Material("entities/attachs/go_perk_headshot.png")
...
-- ATT.Icon = Material("entities/attachs/go_perk_juggernaut.png")
...
-- ATT.Icon = Material("entities/attachs/go_perk_ace.png")
...
ATT.Icon = Material("entities/attachs/go_perk_bolt.png")
...
ATT.Icon = Material("entities/attachs/go_perk_burst.png")
...
ATT.Icon = Material("entities/attachs/go_perk_cowboy.png")
...
ATT.Icon = Material("entities/attachs/go_perk_diver.png")
...
ATT.Icon = Material("entities/attachs/go_perk_lounge.png")
...
ATT.Icon = Material("entities/attachs/go_perk_speed_melee.png")
...
-- ATT.Icon = Material("entities/attachs/go_perk_last.png")
...
ATT.Icon = Material("entities/attachs/go_perk_light.png")
...
ATT.Icon = Material("entities/attachs/go_perk_quickdraw.png")
...
ATT.Icon = Material("entities/attachs/go_perk_rapidfire.png")
...
-- ATT.Icon = Material("entities/attachs/go_perk_refund.png")
...
-- ATT.Icon = Material("entities/attachs/go_perk_slow.png")
