csstring = {
	...
	["knife_t"] = { name = "Knife", desc = "Quiet and always available, the knife has a fast, low-damage primary attack and a slow, high-damage secondary attack. A backstab will earn quiet players an instant kill." },
	["knife_gg"] = "Gold Knife",
    ...
    ["glock_use"] = "• Deadly up close, just a nuisance at range[br]• Consider in the first round of the half[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["hkp2000_use"] = "• Accurate at range, spammable up close[br]• Consider in the first round of the half[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["usp_silencer_use"] = "• Precise, silent, and (somewhat) deadly[br]• Consider in the first round of the half[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["elite_use"] = "• Two rapid-fire pistols for the price of one[br]• Consider in the first round of the half[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["p250_use"] = "• A popular, if modest, damage upgrade[br]• Consider in eco rounds[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["fiveseven_use"] = "• Power, speed, and precision for a price[br]• Consider in eco rounds[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["cz75a_use"] = "• A burst of firepower to steal enemy weapons[br]• Consider in eco rounds[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["tec9_use"] = "• Highly mobile, effective at range and up close[br]• Consider in eco rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["revolver_use"] = "• Deals massive damage after a short delay[br]• Consider in eco rounds[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["deagle_use"] = "• A lethal headshot at any range[br]• Consider in eco rounds[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["taser_use"] = "• A rechargeable one shot kill at short range[br]• Attempt at your own risk[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["bizon_use"] = "• A hail of bullets to mow down unarmored enemies[br]• Consider in the first three rounds of the half[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["mac10_use"] = "• A run and gun tool for breaching bombsites[br]• Consider in the first three rounds of the half[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["mp9_use"] = "• A burst of damage to deny an enemy rush[br]• Consider in the first three rounds of the half[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["mp7_use"] = "• Easy to control for reliable mid-range damage[br]• Consider in force buy rounds[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["mp5sd_use"] = "• Nimble and stealthy for mid-range damage[br]• Consider in force buy rounds[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["ump45_use"] = "• Good armor penetration for mid-range fights[br]• Consider in force buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["p90_use"] = "• An endless bullet hose bested only by rifles[br]• Consider in full buy rounds[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["galilar_use"] = "• Cheap but effective against armored enemies[br]• Consider in force buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["famas_use"] = "• Cheap but effective against armored enemies[br]• Consider in force buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["ak47_use"] = "• The classic, accurate, and deadly workhorse[br]• Consider in full buy rounds[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["m4a1_use"] = "• Good accuracy, with ammo to spare[br]• Consider in full buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["m4a1_silencer_use"] = "• Precise, silent, tracer-free[br]• Consider in full buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["aug_use"] = "• An optional scope for exceptional accuracy[br]• Consider in full buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["sg556_use"] = "• A lethal weapon made deadlier with a scope[br]• Consider in full buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["awp_use"] = "• Devastating power for the confident sniper[br]• Consider in full buy rounds[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["g3sg1_use"] = "• High risk/reward automatic sniper rifle[br]• Consider only under special circumstances[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["scar20_use"] = "• A potent (if risky) tool to hold a position[br]• Consider only under special circumstances[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["ssg08_use"] = "• Light and powerful long-distance damage dealer[br]• Consider in force buy rounds[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["mag7_use"] = "• Take the enemy by surprise, reload, repeat![br]• Consider in force buy rounds[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["nova_use"] = "• Versatile shotgun for close quarter combat[br]• Consider in force buy rounds[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["sawedoff_use"] = "• High powered shotgun for close engagements[br]• Consider in force buy rounds[br]• Difficulty: <color=191,191,64>★★</color>\n\n",
    ["xm1014_use"] = "• A full-auto rapid-fire monster[br]• Consider in force buy rounds[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["m249_use"] = "• At least you won't have to reload...[br]• Consider only under special circumstances[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["negev_use"] = "• Pin-point suppressive fire to buy some time[br]• Consider in force buy rounds[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["hegrenade_use"] = "• Deal damage or clear smoke grenades[br]• Use with discretion[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["flashbang_use"] = "• Blinds/deafens nearby players[br]• Throw prior to an attack[br]• Difficulty: <color=191,64,64>★★★★</color>\n\n",
    ["smokegrenade_use"] = "• Creates a large smoke cloud[br]• Throw to cut off enemy line of sight[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["decoy_use"] = "• Mimics a weapon firing sound[br]• Throw early to confuse the enemy[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["molotov_use"] = "• Clears out hiding spots with fire[br]• Throw before attacking a bombsite[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["incgrenade_use"] = "• Stifles enemy attacks with fire[br]• Throw at the first sign of trouble[br]• Difficulty: <color=191,146,64>★★★</color>\n\n",
    ["assaultsuit_use"] = "• Survive all but the most lethal bullets[br]• Consider in full buy and force buy rounds[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["kevlar_use"] = "• Protects everything but your head[br]• Consider in the first round of the half[br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["defuser_use"] = "• Cut your defusing time in half[br]• Don't be a loser, buy a defuser![br]• Difficulty: <color=64,191,64>★</color>\n\n",
    ["cutters_use"] = "• Pick up hostages in a fraction of the time[br]• Consider when you have extra funds[br]• Difficulty: <color=64,191,64>★</color>\n\n",
}
