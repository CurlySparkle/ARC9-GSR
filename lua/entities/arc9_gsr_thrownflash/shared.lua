...
if CLIENT then
    killicon.Add( "arc9_gsr_flash", "vgui/killicons/csgo_flash", Color(251, 85, 25, 255))
end
...
function ENT:Detonate()
	...
	for _, v in ipairs(player.GetAll()) do
		...
		if !traceres.Hit or traceres.Fraction>=1 or traceres.Fraction<=0 then
			...
			if v:GetNWFloat("ARC9_GSR_FlashDistance",v:GetShootPos():Distance(self:GetPos())) < 1100 and v:GetNWFloat("FlashFactor",self:EntityFacingFactor(v)) < tr.endpos:Distance(self:GetPos(v)) then
