...
function ENT:PhysicsCollide(data, physobj)
    if SERVER then
        if data.Speed > 75 then
            self:EmitSound(Sound("weapons/csgo/incgrenade/inc_grenade_bounce-" .. math.random(1,2) .. ".wav"))
        ...
        elseif data.Speed > 25 then
            self:EmitSound(Sound("weapons/csgo/incgrenade/inc_grenade_bounce-" .. math.random(1,3) .. ".wav"))
        end
...
function ENT:Detonate()
    ...
    self:EmitSound("weapons/csgo/incgrenade/inc_grenade_detonate_" .. math.random(1,3) .. ".wav", 120, 100, 1, CHAN_AUTO)
