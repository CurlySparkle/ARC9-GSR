...
if SERVER then
	...
	function ENT:Detonate()
		...
		self:EmitSound( "weapons/csgo/sensorgrenade/sensor_explode.wav", 75, 100, 1, CHAN_AUTO )
	...
	function ENT:Fuse(ent)
		if SERVER then
			...
			self:EmitSound( "weapons/csgo/sensorgrenade/sensor_arm.wav", 75, 100, 1, CHAN_AUTO )
